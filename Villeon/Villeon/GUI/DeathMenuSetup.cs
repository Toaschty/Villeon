...
namespace Villeon.GUI
{
    public class DeathMenuSetup
    {
        ...
        public DeathMenuSetup()
        {
            //_entities = new List<Entity>();

            //// Load Sprites
            //Sprite deathMenuBackground = Assets.GetSprite("GUI.Scroll_DeathMenu.png", Render.SpriteLayer.ScreenGuiBackground, false);
