...
namespace Villeon.Systems
{
    internal class TriggerSystem : System, IUpdateSystem
    {
        ...
        public void Update(float time)
        {
            ...
            //        switch (trigger.Type)
            //        {
            //            case TriggerLayer.MOB: mobEntities.Add(Entities.ElementAt(i)); break;
            //            case TriggerLayer.DAMAGE: damageEntities.Add(Entities.ElementAt(i)); break;
            //            case TriggerLayer.PORTAL: portalEntities.Add(Entities.ElementAt(i)); break;
            //        }
