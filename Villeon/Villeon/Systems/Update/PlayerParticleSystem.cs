            ...
            foreach (IEntity entity in Entities)
            {
                ...
                if (_particleSpawnDelay <= 0f)
                {
                    ...
                    if (player.IsWalking && StateManager.IsGrounded)
                    {
                        ...
                        direction.Y = 0;
                        IEntity particleEntity = ParticleBuilder.RandomParticle(transform.Position + new Vector2(0.5f, 0f), 0.8f, 0.7f, direction, 0.0f, 0.3f, true, "Sprites.Dust.png", Color4.White);
